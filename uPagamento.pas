...
//**********************************************
procedure TfrmPagamento.edtParcelasKeyUp(Sender: TObject; var Key: Word;
  var KeyChar: Char; Shift: TShiftState);
begin
...
//************************************************
procedure TfrmPagamento.fExecuteTEF(Tipo,Id,Amount,Parcelas,TipoParcelamento,Product,HabilitaImpressao:string);
begin
...
//************************************************
procedure TfrmPagamento.cmdEnviarTransacaoClick(Sender: TObject);
var
...
//**********************************************
procedure TfrmPagamento.cmdEnviarTransacaoKeyUp(Sender: TObject; var Key: Word;
  var KeyChar: Char; Shift: TShiftState);
begin
...
//**********************************************
procedure TfrmPagamento.cmdCancelarTransacaoClick(Sender: TObject);
var
...
//**********************************************
procedure TfrmPagamento.cmdFuncoesClick(Sender: TObject);
begin
  try
...
//************************************************
procedure TfrmPagamento.RandomValor;
var strAux:string;
    i:integer;
begin
